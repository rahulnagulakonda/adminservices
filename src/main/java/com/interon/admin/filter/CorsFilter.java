/*
 * package com.interon.admin.filter;
 * 
 ...
 * FilterChain chain) throws IOException, ServletException { final
 ...
 * "3600"); if ("OPTIONS".equalsIgnoreCase(((HttpServletRequest)
 * req).getMethod())) { response.setStatus(HttpServletResponse.SC_OK); } else {
